...
@section('main')
    ...
    @include('site.sections.home-header')
        ...
        <section class="pxp-hero pxp-hero-bg pxp-cover" style="background-image: url({{ asset('public/storage/'. $page_data->image) }});">
            <div class="pxp-hero-opacity"></div>
            <div class="pxp-hero-caption">
                <div class="pxp-container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-xl-10 col-xxl-9">
                            <h1 class="text-white text-center">{{ $page_data->meta_title }}</h1>

                            <div class="pxp-hero-form pxp-hero-form-round pxp-large mt-4 mt-lg-5">
                                <form class="row gx-3 align-items-center" action="{{ route('search') }}" method="POST">
                                    @csrf
                ...
                <div class="row justify-content-between align-items-center mt-4 mt-md-5">
                    <div class="col-lg-6 col-xxl-5">
                        <div class="pxp-info-fig pxp-animate-in pxp-animate-in-right">
                            <div class="pxp-info-fig-image pxp-cover" style="background-image: url({{ asset('img/psy.jpg') }});"></div>
                    ...
                    <div class="col-lg-5 col-xxl-6">
                        <div class="pxp-info-caption pxp-animate-in pxp-animate-in-top mt-4 mt-sm-5 mt-lg-0">
                            ...
                            <p class="pxp-text-light">{!! $page_data->short_text !!}</p>
                            {!! $page_data->content !!}
            ...
            <div class="pxp-container">
                ...
                <div class="row justify-content-evenly mt-4 mt-md-5 pxp-animate-in pxp-animate-in-top">
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-1.png') }}" alt="Найти себя">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-8.png') }}" alt="Понять психосоматику">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-3.png') }}" alt="Пережить расставание">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-4.png') }}" alt="Повысить самооценку">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-2.png') }}" alt="Справиться с тревогой, страхами, депрессией">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-5.png') }}" alt="Разобраться с выгоранием и прокрастинацией">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-6.png') }}" alt="Справиться с ощущением безнадежности">
                            </div>
                    ...
                    <div class="col-lg-3 col-xl-3 pxp-services-1-item-container">
                        <div class="pxp-services-1-item text-center">
                            <div class="pxp-services-1-item-icon">
                                <img src="{{ asset('img/icons/icon-7.png') }}" alt="Сделать трудный выбор">
                            </div>
                    ...
                    <div class="col pxp-companies-card-1-container">
                        <div class="pxp-companies-card-1 pxp-has-shadow">
                            <div class="pxp-companies-card-1-top">
                                <a href="/{{ $category->path }}" class="pxp-companies-card-1-company-logo" style="background-image: url({{ asset('public/storage/'. $category->image) }});"></a>
                                <a href="/{{ $category->path }}" class="pxp-companies-card-1-company-name">{{ $category->name }}</a>
                                <div class="pxp-companies-card-1-company-description pxp-text-light">{{ $category->short_text }}</div>
                            </div>
                        </div>
                    </div>
                    @endforeach
        ...
        <section class="mt-100">
            <div class="pxp-container">
                <div class="pxp-promo-img pxp-cover pt-100 pb-100 pxp-animate-in pxp-animate-in-top" style="background-image: url({{ asset('img/cla.jpg') }});">
                    <div class="row">
                        <div class="col-sm-7 col-lg-6">
                            <h2 class="pxp-section-h2 text-white">{{ __('site.any_questions') }}</h2>
                            <p class="pxp-text-light text-white">{{ __('site.cta_text') }}</p>
                            <div class="mt-4 mt-md-5">
                                <a href="/contact" class="btn rounded-pill pxp-section-cta">{{ __('site.ask_question') }}<span class="fa fa-angle-right"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
