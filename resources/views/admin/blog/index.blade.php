...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">{{ __('admin.articles') }}</h1>
                ...
                <table class="table-auto w-full">
                    ...
                    <thead class="text-xs font-semibold uppercase text-gray-500 bg-gray-50 border-t border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">{{ __('admin.page_link') }}</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        ...
                        <tr id="item-{{ $item->id }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">
                                    <a class="text-light-blue-500" target="_blank" href="">{{ __('admin.link') }}</a>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                @if ($item->is_active === 1)
                                    <div class="inline-flex font-medium bg-green-100 text-green-600 rounded-full text-center px-2.5 py-0.5">{{ __('admin.show') }}</div>
                                @else
                                    <div class="inline-flex font-medium bg-red-100 text-red-600 rounded-full text-center px-2.5 py-0.5">{{ __('admin.not_show') }}</div>
                                @endif
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div>
                                    ...
                                    <a class="inline-block text-gray-400 hover:text-gray-500" href="/admin/blog_edit/{{ $item->id }}">
                                    ...
                                    <form method="POST" action="/admin/blog_delete/{{ $item->id }}">
                                        @csrf
                                        @method('DELETE')
