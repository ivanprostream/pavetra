            ...
            <div class="flex items-center space-x-3">
                        ...
                        >
                            ...
                            <form class="border-b border-gray-200">
                                <div class="relative">
                                    ...
                                    <input id="modal-search" class="w-full border-0 focus:ring-transparent placeholder-gray-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Search Anything…" x-ref="searchInput" />
                ...
                {{-- <div class="relative inline-flex" x-data="{ open: false }">
                    ...
                    <div
                        ...
                        x-cloak
                    >
                        <div class="text-xs font-semibold text-gray-400 uppercase pt-1.5 pb-2 px-3">Elements</div>
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="{{ route('user_list') }}" @click="open = false" @focus="open = true" @focusout="open = false">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    <button
                        ...
                        :aria-expanded="open"
                    >
                        <img class="w-8 h-8 rounded-full" src="{{ asset('img/avatar-04.jpg') }}" width="32" height="32" alt="User" />
                    ...
                    >
                        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
                            <div class="font-medium text-gray-800">{{ auth()->user()->roles->first()->name; }}</div>
                            <div class="text-xs text-gray-500 italic">{{ __('admin.access_level') }}</div>
                        </div>
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="{{ route('localization') }}" @click="open = false" @focus="open = true" @focusout="open = false">{{ __('admin.localization') }}</a>
                            </li>
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="{{ route('settings') }}" @click="open = false" @focus="open = true" @focusout="open = false">{{ __('admin.settings') }}</a>
                            </li>

                            <li>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3">{{ __('admin.logout') }}</button>
                                </form>
