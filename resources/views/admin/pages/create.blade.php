...
<form action="/admin/page_create" method="POST" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="p-6 space-y-6">
        <h2 class="text-2xl text-gray-800 font-bold mb-5">{{ __('admin.add_page') }}</h2>
            ...
            <section>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    ...
                    <div class="sm:w-1/3">
                        <label class="block text-sm font-medium mb-1" for="user_name">{{ __('admin.short_text') }}</label>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="in_menu" class="form-select w-full" name="in_menu">
                            <option value="1">{{ __('admin.show_in_header') }}</option>
                            <option value="2">{{ __('admin.show_in_footer') }}</option>
