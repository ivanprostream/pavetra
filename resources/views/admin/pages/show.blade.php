                ...
                <table class="table-auto w-full">
                    ...
                    <thead class="text-xs font-semibold uppercase text-gray-500 bg-gray-50 border-t border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">{{ __('admin.short_text') }}</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                        ...
                        <tr id="item-{{ $item->id }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium">
                                    <a class="text-light-blue-500" target="_blank" href="{{ url($item->path) }}">{{ $item->path }}</a>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div>
                                    ...
                                    <a class="inline text-gray-400 hover:text-gray-500" href="/admin/page_show/{{ $item->id }}">
                                    ...
                                    <a class="inline-block text-gray-400 hover:text-gray-500" href="/admin/page_edit/{{ $item->id }}">
                                    ...
                                    <form method="POST" action="/admin/page_delete/{{ $item->id }}">
                                        @csrf
                                        @method('DELETE')
