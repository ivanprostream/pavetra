        ...
        <div class="flex flex-col md:flex-row md:-mr-px">
                    ...
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-indigo-50" :class="settingsPanel === 'notifications' && 'bg-indigo-50'" href="/admin/lang_list">
                                ...
                                <span class="text-sm font-medium text-indigo-500 " :class="settingsPanel === 'notifications' ? 'text-indigo-500' : 'hover:text-gray-700'">{{ __('admin.languages') }}</span>
                            </a>
                        </li>
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
            ...
            <div class="grow">
                ...
                <div class="p-6 space-y-6">
                    <section>
                        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1">{{ __('admin.languages') }}</h3>
                        <ul>
                            ...
                            <li class="md:flex md:justify-between md:items-center py-3 border-b border-gray-200">
                                ...
                                <div class="text-sm text-gray-800ml-4">
                                    ...
                                    <a class="font-medium text-indigo-500 hover:text-indigo-600" href="/admin/lang_edit/{{ $item->id }}">{{ __('admin.edit') }}</a>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                        ...
                        <form action="/admin/lang_new" method="POST">
                            ...
                            <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                                <div class="sm:w-1/3">
                                    ...
                                    <input id="country" class="form-input w-full" name="name" type="text" placeholder="{{ __('admin.lang') }}" value="{{ old('name') }}" />
                                    @error('name')
