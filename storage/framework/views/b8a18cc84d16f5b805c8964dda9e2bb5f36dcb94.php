...
<form action="/admin/user_create" method="POST" autocomplete="off">
    ...
    <div class="p-6 space-y-6">
        <h2 class="text-2xl text-gray-800 font-bold mb-5"><?php echo e(__('admin.add_user')); ?></h2>
            ...
            <section>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    <div class="sm:w-1/3">
                        ...
                        <input id="user_name" class="form-input w-full" name="name" type="text" placeholder="<?php echo e(__('admin.user_name')); ?>" value="<?php echo e(old('name')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <input id="phone" class="form-input w-full" name="phone" type="text" placeholder="<?php echo e(__('admin.phone')); ?>" value="<?php echo e(old('phone')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="gender" class="form-select w-full" name="gender">
                            <option value="1"><?php echo e(__('admin.man')); ?></option>
                            <option value="0"><?php echo e(__('admin.woman')); ?></option>
                        </select>
            ...
            <section>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    <div class="sm:w-1/3">
                        ...
                        <input id="email" class="form-input w-full" name="email" type="email" placeholder="<?php echo e(__('admin.email_adress')); ?>" value="<?php echo e(old('email')); ?>" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views/admin/users/create.blade.php ENDPATH**/ ?>