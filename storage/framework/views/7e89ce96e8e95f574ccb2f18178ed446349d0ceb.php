...
<form action="/admin/page_edit/<?php echo e($page_data->id); ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
    <!-- Panel body -->
    <div class="p-6 space-y-6">
        <h2 class="text-2xl text-gray-800 font-bold mb-5"><?php echo e(__('admin.edit_page')); ?></h2>
            ...
            <section>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    <div class="sm:w-1/3">
                        ...
                        <input id="name" class="form-input w-full" name="name" type="text" placeholder="<?php echo e(__('admin.name')); ?>" value="<?php echo e(old('name', $page_data->name)); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        <div class="mt-3">
                            ...
                            <input id="url" class="form-input w-full" name="url" type="text" placeholder="Url" value="<?php echo e(old('url', $page_data->url)); ?>" />
                            <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <textarea class="form-input w-full" name="short_text" cols="30" rows="5"><?php echo e(old('short_text', $page_data->short_text)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <?php if( $page_data->image ): ?>
                            <img width="100" src="<?php echo e(asset('public/storage/'. $page_data->image)); ?>" alt="<?php echo e($page_data->name); ?>">
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-5">
                    <textarea name="content" id="summernote" cols="30" rows="20" class="form-input w-full"><?php echo e(old('content', $page_data->content)); ?></textarea>
            ...
            <section>
                ...
                <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                    <div class="sm:w-1/3">
                        ...
                        <input id="meta_title" class="form-input w-full" name="meta_title" type="text" placeholder="Meta title" value="<?php echo e(old('meta_title', $page_data->meta_title)); ?>" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <textarea class="form-input w-full" name="meta_description" cols="30" rows="2"><?php echo e(old('meta_description', $page_data->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <textarea class="form-input w-full" name="meta_keywords" cols="30" rows="2"><?php echo e(old('meta_description', $page_data->meta_keywords)); ?></textarea>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="lang" class="form-select w-full" name="lang_id">
                            <?php $__currentLoopData = $country_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($item->id === $page_data->lang_id ? "selected" : ""); ?> value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="page_type" class="form-select w-full" name="page_type_id">
                            <?php $__currentLoopData = $template_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($item->id === $page_data->page_type_id ? "selected" : ""); ?> value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="parent" class="form-select w-full" name="parent">
                            ...
                            <?php $__currentLoopData = $page_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($item->id === $page_data->parent ? "selected" : ""); ?> value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="is_active" class="form-select w-full" name="is_active">
                            <option <?php echo e(1 === $page_data->is_active ? "selected" : ""); ?> value="1"><?php echo e(__('admin.show')); ?></option>
                            <option <?php echo e(0 === $page_data->is_active ? "selected" : ""); ?> value="0"><?php echo e(__('admin.not_show')); ?></option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="in_menu" class="form-select w-full" name="in_menu">
                            <option <?php echo e(1 === $page_data->in_menu ? "selected" : ""); ?> value="1"><?php echo e(__('admin.show_in_header')); ?></option>
                            <option <?php echo e(2 === $page_data->in_menu ? "selected" : ""); ?> value="2"><?php echo e(__('admin.show_in_footer')); ?></option>
                            <option <?php echo e(3 === $page_data->in_menu ? "selected" : ""); ?> value="3"><?php echo e(__('admin.show_everywhere')); ?></option>
                            <option <?php echo e(0 === $page_data->in_menu ? "selected" : ""); ?> value="0"><?php echo e(__('admin.show_nowhere')); ?></option>
                        </select>
                        <?php $__errorArgs = ['is_active'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views\admin\pages\edit.blade.php ENDPATH**/ ?>