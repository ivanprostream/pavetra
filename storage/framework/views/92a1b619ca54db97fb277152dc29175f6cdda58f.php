...
<form action="/admin/category_create" method="POST" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="p-6 space-y-6">
        <h2 class="text-2xl text-gray-800 font-bold mb-5"><?php echo e(__('admin.add_category')); ?></h2>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:w-1/3">
                        ...
                        <select id="in_tags" class="form-select w-full" name="in_tags">
                            ...
                            <option value="1"><?php echo e(__('admin.show_in_home')); ?></option>
                            <option value="2"><?php echo e(__('admin.show_in_sidebar')); ?></option>
                            <option value="3"><?php echo e(__('admin.show_everywhere')); ?></option>
                        </select>
                        <?php $__errorArgs = ['in_tags'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views\admin\categories\create.blade.php ENDPATH**/ ?>