        ...
        <div class="flex flex-col md:flex-row md:-mr-px">
            ...
            <div class="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-gray-200 min-w-60 md:space-y-3">
                ...
                <div>
                    <ul class="flex flex-nowrap md:block mr-3 md:mr-0">
                        ...
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
                            <a class="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-indigo-50" :class="settingsPanel === 'notifications' && 'bg-indigo-50'" href="/admin/lang_list">
                                <svg class="w-4 h-4 shrink-0 fill-current mr-2 text-indigo-400" :class="settingsPanel === 'notifications' && 'text-indigo-400'" viewBox="0 0 16 16">
                                    <path d="M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8zM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1z" />
                                </svg>
                                <span class="text-sm font-medium text-indigo-500 " :class="settingsPanel === 'notifications' ? 'text-indigo-500' : 'hover:text-gray-700'"><?php echo e(__('admin.languages')); ?></span>
                            </a>
                        </li>
                        <li class="mr-0.5 md:mr-0 md:mb-0.5">
            ...
            <div class="grow">
                ...
                <div class="p-6 space-y-6">
                    <section>
                        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1"><?php echo e(__('admin.languages')); ?></h3>
                        <ul>
                            ...
                            <li class="md:flex md:justify-between md:items-center py-3 border-b border-gray-200">
                                ...
                                <div class="text-sm text-gray-800ml-4">
                                    ...
                                    <a class="font-medium text-indigo-500 hover:text-indigo-600" href="/admin/lang_edit/<?php echo e($item->id); ?>"><?php echo e(__('admin.edit')); ?></a>
                                </div>
                            </li>
                ...
                <footer>
                    <div class="px-6 py-8 border-t border-gray-200">
                        ...
                        <form action="/admin/lang_new" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="sm:flex sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-5">
                                <div class="sm:w-1/3">
                                    <label class="block text-sm font-medium mb-1" for="user_name"><?php echo e(__('admin.lang')); ?></label>
                                    <input id="country" class="form-input w-full" name="name" type="text" placeholder="<?php echo e(__('admin.lang')); ?>" value="<?php echo e(old('name')); ?>" />
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views\admin\lang_list.blade.php ENDPATH**/ ?>