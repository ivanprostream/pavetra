...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-5">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold"><?php echo e(__('admin.categories')); ?></h1>
                        ...
                        <tr id="item-<?php echo e($item->id); ?>">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium text-gray-800">
                                    <a class="text-light-blue-500" target="_blank" href="<?php echo e(url($item->path)); ?>"><?php echo e($item->name); ?></a>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div>
                                    <a class="inline text-gray-400 hover:text-gray-500" href="/admin/category_show/<?php echo e($item->id); ?>">
                                    ...
                                    <a class="inline-block text-gray-400 hover:text-gray-500" href="/admin/category_edit/<?php echo e($item->id); ?>">
                                    ...
                                    <form method="POST" action="/admin/category_delete/<?php echo e($item->id); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>