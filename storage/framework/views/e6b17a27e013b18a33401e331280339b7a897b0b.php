    ...
    <header class="px-5 py-4 border-b border-gray-100 flex items-center">
        ...
        >
            ...
            <div class="z-10 absolute bottom-full left-1/2 transform -translate-x-1/2">
                <div
                    class="min-w-72 bg-white border border-gray-200 p-3 rounded shadow-lg overflow-hidden mb-2"
                    x-show="open"
...
<?php /**PATH C:\OpenServer\domains\localhost\pavetra.loc\resources\views\admin\partials\dashboard-card-09.blade.php ENDPATH**/ ?>